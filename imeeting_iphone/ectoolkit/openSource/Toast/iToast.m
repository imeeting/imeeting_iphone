...
- (void) show{
	...
	UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, textSize.width + 0, textSize.height + 5)];
	...
	if (theSettings.gravity == iToastGravityTop) {
		...
		point = CGPointMake(window.frame.size.width / 2, window.frame.size.height - 60);
